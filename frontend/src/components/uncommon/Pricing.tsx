...
const Pricing = () => {
  return (
    <div>
      <section className="body-font overflow-hidden text-black">
        <div className="container mx-auto px-5 py-24">
          <div className="mb-20 flex w-full flex-col text-center">
            ...
            <div className="mx-auto mt-6 flex overflow-hidden rounded border-2 border-indigo-500">
              ...
              <button className="px-4 py-1 text-black focus:outline-none">
                Annually
              </button>
            </div>
          </div>
          <div className="-m-4 flex flex-wrap">
            <div className="w-full p-4 md:w-1/2 xl:w-1/4">
              <div className="relative flex h-full flex-col overflow-hidden rounded-lg border-2 border-gray-700 p-6">
                <h2 className="title-font mb-1 text-sm font-medium tracking-widest text-black">
                  START
                </h2>
                <h1 className="mb-4 border-b border-gray-800 pb-4 text-5xl leading-none text-black">
                  Free
                </h1>
                <p className="mb-2 flex items-center text-black">
                  <span className="mr-2 inline-flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full bg-gray-800 text-black">
                    <svg
                      fill="none"
                      stroke="currentColor"
                ...
                <p className="mb-6 flex items-center text-black">
                  <span className="mr-2 inline-flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full bg-gray-800 text-black">
                    <svg
                      fill="none"
                      stroke="currentColor"
                ...
                <button className="mt-auto flex w-full items-center rounded border-0 bg-gray-800 px-4 py-2 text-white hover:bg-gray-700 focus:outline-none">
                  Button
                  <svg
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="w-full p-4 md:w-1/2 xl:w-1/4">
              <div className="relative flex h-full flex-col overflow-hidden rounded-lg border-2 border-indigo-500 p-6">
                ...
                <h1 className="mb-4 flex items-center border-b border-gray-800 pb-4 text-5xl leading-none text-white">
                  <span>$38</span>
                  <span className="ml-1 text-lg font-normal text-black">
                    /mo
                  </span>
                </h1>
                <p className="mb-2 flex items-center text-black">
            ...
            <div className="w-full p-4 md:w-1/2 xl:w-1/4"></div>
          </div>
        </div>
      </section>
    </div>
